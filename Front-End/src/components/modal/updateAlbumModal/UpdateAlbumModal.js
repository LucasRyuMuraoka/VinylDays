			...
			>
				...
				<Form>
					<InputContainer>
						...
						<Input type="text" placeholder="Insert a album name..." minLength={ 4 } maxLength={ 45 } required={ true } value={ name } onChange={ (e) => setName(e.target.value) }/>
					</InputContainer>

					<InputContainer>
						<Label>Artist:&nbsp;<span>*</span></Label>
						<Input type="text" placeholder="Insert a artist name..." minLength={ 4 } maxLength={ 60 } required={ true } value={ artist } onChange={ (e) => setArtist(e.target.value) } />
					</InputContainer>
